...
complete_diallel2 <- read_csv("./../data/full_diallel_random_anova.csv")
...
half_diallel1 <- read_csv("./../data/half_diallel_fixed_anova.csv")
...
half_diallel2 <- read_csv("./../data/half_diallel_random_anova.csv")
...
half_diallel_pht_clean %>%
  ...
  rename("Genotype" = "Genotype_female") %>% 
