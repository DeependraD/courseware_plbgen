...
$V_{P1} = E; \quad V_{P2} = E; \quad V_{F1} = E$
...
Elsewhere, following relation is also mentioned: $$V_{E} = \frac{V_{P1} + V_{P2} + V_{F1}}{3} \tag{Equation 1} \label{eqn:lab1}$$

\@ref{eqn:lab1} was the worst of all.
...
Following known relation can be used:
...
```{r heritability-estimates-filial-population2}
...
$h^2_{bs}$ = `r heritability_ns`

For simplified calculation, refer to Acquaah, P 86.
