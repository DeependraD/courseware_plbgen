...
```{r x-men, fig.cap="Mutant seekers", fig.height=3, out.height="40%"}
...
```{r borlaug, fig.cap="Dr. Borlaug working in a wheat crossing block", fig.height=3, out.height="70%"}
...
```{r modern-triticum-uk, fig.cap="Modern wheat genotype under test in cool temperate region (UK)", fig.height=3, fig.width = 4, out.height="40%"}
...
`r knitr::include_graphics("./../../images/Triticum_species.jpg")`
