...
For a thorough discussion of topic, refer to:
  - An Introduction to Population Genetics Theory by Crow and Kimura (1970, reprinted 2009)
...
## Sickle cell anaemia (A recessive blood phenotype)

```{r blood-condition, fig.align='center', out.width="45%"}
knitr::include_graphics("./images/blood_conditions.jpg")
```
