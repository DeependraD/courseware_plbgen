...
```{r plant-improvement-timeline, out.width="85%", fig.cap="A timeline view of crop improvement activities in the past in Nepal."}
...
```{r anadi-kailali, fig.cap="Andi; A local landrace of rice found in Baluwaphanta, Kailali.", out.width="94%"}
knitr::include_graphics("./images/anadi_kailali.jpg")
```

\ecolumns

## Wheat, buckwheat, millet, oilseed and vegetables

```{r landraces-wheat-buckwheat-millet-oilseed-veg}
...
landraces %>% 
  ...
  knitr::kable(booktabs = TRUE, caption = "Some landraces of cultivated crops unique to Nepal") %>% 
  kableExtra::kable_styling(font_size = 8) %>% 
  kableExtra::column_spec(column = 1:3, width = c("5em", "12em", "34em"))
...
landraces %>% 
  filter(crop %in% "Rice") %>% 
  rename_with(~str_to_sentence(.)) %>% 
  knitr::kable(booktabs = TRUE, caption = "Some landraces of cultivated crops unique to Nepal (...continued)") %>% 
  kableExtra::kable_styling(font_size = 8) %>% 
  kableExtra::column_spec(column = 1:3, width = c("5em", "12em", "34em"))
```

# Crop breeding programs and activities

##

```{r breeding-phases, fig.width=4, out.width="70%", fig.align='center', fig.cap="Plant breeding activities commonly practiced in Nepal."}
...
breeding_programs_nepal %>% 
  ...
  kableExtra::kable_styling(font_size = 8) %>% 
  kableExtra::column_spec(column = 1:6, width = c("5em", "8em", "8em", "8em", "8em"))
```
...
breeding_programs_nepal %>% 
  ...
  kableExtra::column_spec(column = 1:6, width = c("5em", "10em", "8em", "14em", "8em"))
...
breeding_programs_nepal %>% 
  ...
  knitr::kable(booktabs = TRUE) %>% 
  kableExtra::kable_styling(font_size = 7) %>% 
  kableExtra::column_spec(column = 1:6, width = c("5em", "10em", "11em", "14em", "8em"))
...
- Relevant policies, acts, and regulations are:
  \begin{itemize}
  \footnotesize
  \item Plant protection regulations, 1975
  \item Seed act, 1988 (Amendment 2008)
  \item Seed regulations, 1997
  \item National seed policy, 1999
  \item National agriculture policy, 2004
  \item Biotechnology policy, 2006
  \item Plant protection act, 2007
  \item Agrobiodiversity policy, 2007 (Amendment 2014)
  \item National biosafety framework, 2007
  \item National seed vision, 2013-25
  \item National biodiversity strategy and action plan, 2014-20
  \item Agriculture developmenet strategy, 2015-35
  \item NARC vision, 2011-30
  \end{itemize}

\column{0.4\textwidth}

```{r makkai-theme, out.width="90%", fig.align='center'}
