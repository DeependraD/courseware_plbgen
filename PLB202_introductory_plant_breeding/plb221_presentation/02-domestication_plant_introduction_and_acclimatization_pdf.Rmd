...
- Because of the roles of humans (*Domesticators*), the process results characteristics that are beneficial to humans but some that would be disadvantageous for plants in their natural habitats.
...
```{r linkage-domestication-syndrome, fig.cap="Linkages among genes controlling the domestication syndrome in various crops. Source: \\cite{gepts2010crop}.", out.width="75%"}
...
```{r domesticated, fig.cap="Domesticated dog", fig.show='hold', out.width="0.4\\textwidth, keepaspectratio"}
knitr::include_graphics("./images/domestic_dog_puppy.jpg")
```


```{r wild, fig.cap="Wild dog", fig.show='hold', out.width="0.4\\textwidth, keepaspectratio"}
...
- Genetic resources such as seeds or tissues that are maintained for the purpose of animal and plant breeding, preservation, and other research uses. 
...
domestication_origin[1:10,] %>% 
  knitr::kable(booktabs = TRUE, caption = "Estimated time of domestication and centre of origin of major crop species; @brown2014plant, Page 23", align = "l") %>% 
...
megacentres[1:14,] %>% 
  knitr::kable(booktabs = TRUE, caption = "Cultivated plants and their regions of diversity. Based on Zeven and Zhukovsky (1975) and Zeven and de Wet (1982); @hayward2012plant, Page 54, 55.", align = "l") %>% 
  kableExtra::kable_styling(latex_options = "striped", font_size = 6) %>% 
...
```{r cryo-tank-banana, fig.cap="Cryotanks for conservation of global banana germplasm.", out.width = "60%"}
