...
where $m$ is the number of generations of selfing or backcrosses. Same relation also gives the proportion of homozygous individuals in any generations of recurrent selfing. For example, for $3^{rd}$ BC generation,
