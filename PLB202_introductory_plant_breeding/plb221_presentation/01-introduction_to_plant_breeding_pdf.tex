...
\footnotesize -- Jean and Andre Mayer (1974) \column{0.5\textwidth}
...
\begin{center}\includegraphics[width=0.45\linewidth]{images/life-of-an-artist-funny-comics-9} \end{center}

\begin{center}\includegraphics[width=0.65\linewidth]{images/art-negative-space-design-art-illustration} \end{center}
