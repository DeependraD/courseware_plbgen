...
## Applications/uses of aneuploidy in plant breeding

- They have been used to determine the phenotypic effects of loss or gain of different chromosomes.
- They are useful in the production of substitution lines.
- They are useful in identifying the chromosomes involved in translocations.
- They are useful in locating a linkage group and a gene to a particular chromosome.
- They are also used to produce alien addition and alien substitution lines which are useful in gene transfer from one species to other species.
...
a. Parthenogenesis: from unfertilized egg cell.
b. Apogamy: from antipodal and synergids
c. Androgenesis: from male nucleus. It contains paternal genotype and maternal plasmotype.
d. Semigamy: from unfused male and female gametes independently.
e. Genome elimination to distant hybridization.
f. Chemical treatment
g. Temperature shocks
h. Irradiation: x-ray, UV rays
