...
{\centering \includegraphics[width=0.85\linewidth]{./images/fertilization_in_self_pollinated_species} 

}

\caption{Fertilization in self pollinated plants.}\label{fig:plant-fertilization}
\end{figure}
...
{\centering \includegraphics[width=0.64\linewidth]{./images/male_gametophyte} 

}

\caption{Haploid male gametophyte (pollen) of Arabidopsis comprising the vegetative cell (producing the growing pollen tube) and two non-motile sperm cells enclosed within the membrane of the vegetative tube cell.}\label{fig:gametophyte-male}
\end{figure}

\begin{figure}
\includegraphics[width=0.55\linewidth]{./images/female_gametophyte} \caption{pollen tube approaching the Arabidopsis ovule. The tube grows along the funiculus, through the micropyle of the ovule and towards the haploid female gametophyte that comprises the egg cell, central cell and accessory cells (synergid and antipodal cells).}\label{fig:gametophyte-female}
\end{figure}
...
\addlinespace
\cellcolor{gray!6}{4} & \cellcolor{gray!6}{S1S2Z1Z3} & \cellcolor{gray!6}{S1S2Z1Z2} & \cellcolor{gray!6}{S2Z1} & \cellcolor{gray!6}{Incompatible} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{S1Z1} & \cellcolor{gray!6}{Incompatible} & \cellcolor{gray!6}{}\\
4 & S1S2Z1Z3 & S1S2Z1Z2 & S2Z3 & Compatible &  & S1Z1 & Incompatible & \\
\cellcolor{gray!6}{5} & \cellcolor{gray!6}{S3S4Z3Z4} & \cellcolor{gray!6}{S1S2Z1Z2} & \cellcolor{gray!6}{S3Z3} & \cellcolor{gray!6}{Compatible} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{S3Z3} & \cellcolor{gray!6}{Compatible} & \cellcolor{gray!6}{}\\
5 & S3S4Z3Z4 & S1S2Z1Z2 & S3Z4 & Compatible &  & S3Z3 & Compatible & \\
\bottomrule
\multicolumn{9}{l}{\rule{0pt}{1em}\textit{Assumptions:}}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Suppose there are incompatibility conditioning genes S and Z}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Two genes could have alleles S1, S2, S3, S4… and Z1, Z2, Z3, Z4,…}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Under SSI system, dominance relation holds: S1>S2>S3 and Z1>Z2>Z3.}\\
\end{tabular}
\end{table}
\end{frame}
...
\addlinespace
\cellcolor{gray!6}{8} & \cellcolor{gray!6}{S1S3Z2Z3} & \cellcolor{gray!6}{S1S2Z1Z3} & \cellcolor{gray!6}{S1Z2} & \cellcolor{gray!6}{Compatible} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{S1Z2} & \cellcolor{gray!6}{Compatible} & \cellcolor{gray!6}{}\\
8 & S1S3Z2Z3 & S1S2Z1Z3 & S1Z3 & Incompatible &  & S1Z2 & Compatible & \\
\cellcolor{gray!6}{8} & \cellcolor{gray!6}{S1S3Z2Z3} & \cellcolor{gray!6}{S1S2Z1Z3} & \cellcolor{gray!6}{S3Z2} & \cellcolor{gray!6}{Compatible} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{S1Z2} & \cellcolor{gray!6}{Compatible} & \cellcolor{gray!6}{}\\
