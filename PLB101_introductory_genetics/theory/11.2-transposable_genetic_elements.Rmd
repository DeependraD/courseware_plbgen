...
- Refer also to:
  - "Active transposons in Rice", Rice Biology in the Genomics Era (Volume 62), Biotechnology in Agriculture and Forestry.

##

- Barbara McClintock, working with corn in the 1940s, was the first to detect transposable elements, which she initially identified as controlling elements (20 years ahead of the discovery of transposable elements in prokaryotes)^[For a detailed discussion on Mobile Elements in Maize refer to [@janick2008plant]]. 
