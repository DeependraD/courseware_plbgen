...
```{r genetics-applications-1, fig.cap="", out.width="70%"}

knitr::include_graphics("../images/wild_flowers_abroad.jpg")
knitr::include_graphics("../images/jacaranda_kathmandu.jpg")
```

  \column{0.5\textwidth}

```{r genetics-applications-2, fig.cap="Crop improvement", out.width="96%"}
