...
```{r meiosis-leptotene, out.width="70%", fig.align='center'}
...
```{r meiosis-zygotene, out.width="70%", fig.align='center'}
...
\end{minipage}\hspace{0.5cm}
\begin{minipage}[t]{0.48\textwidth}
```{r meiosis-pachytene, out.width="70%", fig.align='center'}
...
```{r meiosis-diplotene, out.width="70%", fig.align='center'}
knitr::include_graphics("../images/cell_cycle/meiosis_diplotene.png")
```

```{r meiosis-diakinesis, out.width="70%", fig.align='center'}
...
```{r meiosis-metaphasei, out.width="70%", fig.align='center'}
...
```{r meiosis-early-anaphasei, out.width="70%", fig.align='center'}
knitr::include_graphics("../images/cell_cycle/meiosis_early_anaphasei.png")
```

Anaphase (Late) I

```{r meiosis-late-anaphasei, out.width="70%", fig.align='center'}
...
```{r meiosis-telophasei, out.width="70%", fig.align='center'}
knitr::include_graphics("../images/cell_cycle/meiosis_telophasei.png")
```

Interphase II

```{r meiosis-interphaseii, out.width="70%", fig.align='center'}
...
```{r meiosis-prophaseii, out.width="70%", fig.align='center'}
...
```{r meiosis-metaphaseii, out.width="70%", fig.align='center'}
...
```{r meiosis-anaphaseii, out.width="70%", fig.align='center'}
...
```{r meiosis-telophaseii, out.width="70%", fig.align='center'}
...
```{r meiosis-tetrad, out.width="70%", fig.align='center'}
knitr::include_graphics("../images/cell_cycle/meiosis_tetrad.png")
```

Young pollen grain

```{r meiosis-young-pollen, out.width="70%", fig.align='center'}
