...
```{r codominance-mirabilis, out.width="25%"}
# codominance_mirabilis_mer <- DiagrammeR::mermaid(
#   "
#   graph TB
# 
...
# )
# 
# htmltools::html_print(codominance_mirabilis_mer) %>%
#   webshot2::webshot("../images/codominance_mirabilis_mer.png", vwidth = 240, vheight = 480, zoom = 2)

knitr::include_graphics("../images/codominance_mirabilis_mer.png")
```
...
map2_dfc(.x = (combination_genotypes %>%
  ...
  kable(booktabs = TRUE, format = "latex", escape = FALSE, linesep = "", longtable = TRUE) %>%
