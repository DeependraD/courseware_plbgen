...
output:   
  beamer_presentation:
    ...
    keep_tex: true
    includes:
      in_header: 13-intellectual_property_rights_beamer_header.tex
...
```{r fig-nocap-margin-first, fig.margin=TRUE, fig.width=4, fig.height=4, cache=TRUE, echo=FALSE, out.width="45%"}
...
- What does it take to be a patent attorney or a legal counsel ? Not much
