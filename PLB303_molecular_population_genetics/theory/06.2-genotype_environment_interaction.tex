...
\begin{figure}
\includegraphics[width=0.45\linewidth]{05-genotype_environment_interaction_files/figure-beamer/no-interaction-1} \caption{No interaction}\label{fig:no-interaction}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.45\linewidth]{05-genotype_environment_interaction_files/figure-beamer/non-crossover-1} \caption{Non-crossover interaction}\label{fig:non-crossover}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.35\linewidth]{05-genotype_environment_interaction_files/figure-beamer/crossover-interaction-1} \caption{Crossover interaction}\label{fig:crossover-interaction}
\end{figure}
