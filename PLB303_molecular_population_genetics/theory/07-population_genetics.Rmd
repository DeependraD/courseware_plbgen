...
```{r bacterial-antibiotic-exposure-guides-evolution, out.width="85%"}
...
eq_attainment %>% 
  ...
  kableExtra::column_spec(column = 1:8, width = c("2.6em", rep("4.25em", 2), rep("3.25em", 4), "3.25em"))

```

\column{0.3\textwidth}

```{r ld-decay-plot, fig.width=6, fig.height=4, out.width="95%", fig.align='center', fig.cap="With sexual reproduction and random mating, linkage disequilibrium falls over time. The graph shows the level of linkage disequilibrium between two loci over 40 generations in random-mating populations with different rates of recombination, r. The population starts with the coefficient of LD (D) at its maximum possible value, 0.25."}
