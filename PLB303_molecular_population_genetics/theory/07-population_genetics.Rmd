...
<!-- Refer to media file "Phylogenetic trees - back to basics" for a full length discourse on the topic. -->
...
## Human population genetics -- Useful numbers

<!-- Jonathan Pritchard -->
<!-- https://ecoevo.social/@jkpritch/109542237247291995 -->

\bcolumns
\column{0.5\textwidth}

```{r useful-numbers1, fig.align='center', out.width="70%"}
knitr::include_graphics("../images/useful_numbers_human_pop_gen1.jpg")
```

\column{0.5\textwidth}

```{r useful-numbers2, fig.align='center', out.width="70%"}
knitr::include_graphics("../images/useful_numbers_human_pop_gen2.jpg")
```
