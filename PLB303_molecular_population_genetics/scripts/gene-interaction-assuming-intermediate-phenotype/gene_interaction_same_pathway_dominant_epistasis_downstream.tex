...
% % Dominant epistasis (Gene B is epistatic to Gene A (hypostatic) when in homozygous dominant (BB) or heterozygous (Ba) state)
...
\node[pre block,fill=blue!50] (intermediate) [right=of precursor] {Intermediate compound};
...
% precursor, intermediate and product
\node[pre block] (precursor) at (-5,0) {Precursor};
\node[pre block,fill=green!50] (intermediate) [right=of precursor] {Intermediate compound};
\node[pro block,cross] (product) [right=of intermediate] {Product};
...
\node[pre block] (precursor) at (-5,0) {Precursor};
\node[pre block,fill=green!50] (intermediate) [right=of precursor] {Intermediate compound};
\node[pro block,fill=red!50] (product) [right=of intermediate] {Product};
