...
\hypersetup{
      pdftitle={The nature of gene (one gene one polypeptide hypothesis, enzymatic explanation of genetic ratios, and genetic fine structures},
            colorlinks=true,
    linkcolor=red,
    citecolor=Blue,
    urlcolor=lightgrayd,
...
\hypertarget{genes-at-molecular-level}{%
\section{Genes at molecular level}\label{genes-at-molecular-level}}
...
\item
  ...
  is described by the Central Dogma\footnote<.->{States that genes
    specify the sequence of mRNAs, which in turn specify the sequence of
    proteins}.
\item
...
\item
  ...
  function, it makes intuitive sense that the cell would make mRNA
  copies of this information for protein synthesis, while keeping the
  DNA itself intact and protected.
\item
  The copying of DNA to RNA is relatively straightforward, with one
  nucleotide being added to the mRNA strand for every nucleotide read in
  the DNA strand.
\end{itemize}
...
\tightlist
\item
  The translation to protein is characterized by a universal routine of
  three mRNA nucleotides corresponding to one amino acid in the
  polypeptide sequence.
\item
  However, the translation to protein is still systematic and
  colinear\footnote<.->{in terms of RNA and protein, three ``units'' of
    RNA (nucleotides) specify one ``unit'' of protein (amino acid) in a
    consecutive fashion}, such that nucleotides 1 to 3 correspond to
  amino acid 1, nucleotides 4 to 6 correspond to amino acid 2, and so
  on.
\end{itemize}
...
\begin{figure}
\includegraphics[width=0.24\linewidth]{./../images/central_dogma_genetics} \caption{The central dogma of biology}\label{fig:central-dogma}
\end{figure}
...
\item
  ...
  \item
    ...
    the triplet reading frame\footnote<.->{Reading frame: Sequence of
      triplet codons in mRNA that specify a particular protein; a
      ribosome shift of one or two nucleotides in either direction
      completely abolishes synthesis of that protein}, thereby altering
    the message for every subsequent amino acid.
  \item
...
\item
  These nucleotide triplets are called codons\footnote<.->{Codons: Three
    consecutive nucleotides in mRNA that specify the insertion of an
...
\item
  ...
  triplets and that the genetic code was degenerate\footnote<.->{(of the
    genetic code) describes that a given amino acid can be encoded by
    more than one nucleotide triplet}.
\item
...
\item
  ...
  triplets are called nonsense codons\footnote<.->{one of the three mRNA
    codons that specifies termination of translation}, or stop codons.
\item
...
\item
  ...
  there are about 10\^{}84 possible combinations of 20 amino acids and
  64 triplet codons.
\end{itemize}
...
\begin{center}\includegraphics[width=0.5\linewidth]{./../images/gene_complementation} \end{center}

  \column{0.5\textwidth}


\begin{center}\includegraphics[width=0.7\linewidth]{./../images/gene_same_pathway} \end{center}
